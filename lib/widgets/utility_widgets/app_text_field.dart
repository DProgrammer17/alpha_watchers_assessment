...
import 'package:app_watchers_assessment/utils/textfield_formatter/amount_formatter.dart';
import 'package:app_watchers_assessment/widgets/utility_widgets/keyboard_overlay.dart';
...
class _AppTextfieldState extends State<AppTextfield> {
  ...
  Widget build(BuildContext context) {
    inputBorder = OutlineInputBorder(
      borderRadius: BorderRadius.circular(widget.borderRadius ?? 5.ar),
